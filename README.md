...
🎓 **Telecommunication Engineer | Full-stack Developer | Networking Expert**
...
- 🔐 **Learning Management System (LMS)** — Laravel-based education platform
- 🎂 **Impressive Cake Website** — WordPress & PHP dynamic cake shop with contact forms, WhatsApp integration
- 🌐 **Smart Network Simulation** — WAN & LAN network using Cisco and Huawei simulation tools


### 📬 Connect With Me

- ✉️ Email: [musabasili035@gmail.com]
- 🌍 LinkedIn: [www.linkedin.com/in/musa-basili-82bab62b5]
